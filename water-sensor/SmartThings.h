...
#define BOARD_TYPE BOARD_TYPE_UNO  // default to use UNO
#endif
...
//*******************************************************************************
//
#if BOARD_TYPE == BOARD_TYPE_LEONARDO
class SmartThings 
#else
class SmartThings : private SoftwareSerial
#endif
{
  private:
  ...
  public:
    ...
    /// @param[in] pinRX - Receive Pin for the Serial Port to the Arduino
    /// @param[in] pinTX - Transmit Pin for the Serial Port to the Arduino
